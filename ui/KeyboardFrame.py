...
class KeyboardFrame(ui.View):
    ...
    def setupkb(self):
        ...
        minimizedkb=ui.Button(frame=(0,self.height-15,self.width,15),flex='',bg_color=(.1, .0, .1,.1))
...
if __name__=='__main__':     
    ...
    root.flex='WH'
    root.border_color=(0,0,0,.1)
    root.border_width=2

    root.present(presentmode, hide_title_bar=True)
